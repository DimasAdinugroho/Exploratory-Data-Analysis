...
### Answer
1. We can see from the bar chart, total emission from 1999 to 2008 is dropping each years for all States in US
2. We can see from the bar chart, for total emission in baltimore county dropping each year, except on 2005 
3. We can see from the line chart, total emission in baltimore county by type. The 'Non-point' type, it has the highest emission and 'On-Road' type is the lowest emission.
4. We can see from the bar chart, for all years, the 'POINT' type of emission is the main source for coal emission United States 
6. We can see from the line chart, that emission with Type 'ON-RoAD' from California is higher from Baltimore for all years

### Plot 1

![plot of Rlot3](Rplot1.png) 

### Plot 2

![plot of Rlot3](Rplot2.png) 

### Plot 3

![plot of Rlot3](Rplot3.png) 

### Plot 4

![plot of Rlot4](Rplot4.png) 

### Plot 5 & 6

![plot of Rlot6 and Rlot5](Rplot5.png) 
